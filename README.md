...
The following screenshots show the application in use. You can watch the video of me showcasing the application [here](https://github.com/PasqualePerilli/Sentiment-Analyzer/raw/master/GitHub-Screenshots/showcase.webm), or keep reading below to see the screenshots.
